...
const training_repository_1 = require("./repository/training.repository");
...
exports.TrainingModule = TrainingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [training_service_1.TrainingService, training_repository_1.TrainingRepository, PrismaService_1.PrismaService],
        exports: [training_service_1.TrainingService, training_repository_1.TrainingRepository]
    })
], TrainingModule);
